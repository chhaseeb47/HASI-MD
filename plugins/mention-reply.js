  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(
        config.MENU_IMAGE_URL || "https://files.catbox.moe/8164u3.png",
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "923424283753",
            body: config.DESCRIPTION || "𝐇ᴀsɪ 𝐌ᴅ",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/8164u3.png", // Static image URL
            sourceUrl: "https://wa.me/message/923424283753",
